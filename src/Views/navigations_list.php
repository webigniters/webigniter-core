...
<?= $this->section('content') ?>
    <div class="w-auto pb-4 pt-2 d-flex flex-row-reverse">
        <a class="btn btn-primary me-1 mb-1" href="/cms/navigations/add"><?=ucfirst(lang('general.navigation_add'));?></a>
    </div>
    <div class="card mb-3">
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h3 class="mb-0" data-anchor="data-anchor"><?=ucfirst(lang('general.navigations'));?></h3>
                </div>
            </div>
        </div>
                        ...
                        <div class="table-responsive scrollbar">
                            <table class="table table-bordered table-striped fs--1 mb-0">
                                ...
                                <?php foreach($navigations as $navigation):?>
                                    <tr>
                                        <td class="name fs-0"><a href="/cms/navigation/<?=$navigation->getId();?>"><?=$navigation->getName();?></a></td>
                                        <td class="text-end">
                                             <div>
                                                <?php
                                                $dataArray['question'] = ucfirst(lang('general.delete_question', [lang('general.navigation')]));
                                                $dataArray['link'] = '/cms/navigations/'.$navigation->getId().'/delete';
                                                $dataArray['data'][ucfirst(lang('general.navigation'))] = $navigation->getName();
